...
2. HASO 모델은 자동화 레벨(Level Of Automation, LOA), Adaptive Automation (AA), 컨트롤의 단위 (Granularity Of Control, GOC)를 포함합니다.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzNzY1MTkwMiwxMjk1MTkwMzk1XX0=
-->