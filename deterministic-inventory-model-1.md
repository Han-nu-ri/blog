...
Lead Time이 0이  아니라  고정  상수 l이라고  해도, 별로  복잡하질게  없습니다. 주문해야 하는 시점 측면에서는  재고가 떨어질 시점 보다 l 전에  미리  주문만 하면 되니깐요.  또한 재고의 양  측면에서는 ㅣ * lambda가  남았을  때  주문하면  됩니다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzgwMjU5MzQ4LDEyNDIxMzA4MzgsLTg1Nz
