...
{텐서플로, 딥러닝, 고양이, 강아지} 이 예제로 돌아가보죠. 각 단어를 one-hot encoding의 형태로 표현하기 위해 4차원의 벡터를 사용하였습니다. 잘 살펴보면, 텐서플로와 딥러닝은 유사한 의미를 가지고 있습니다. 고양이와 강아지도 그
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3MzEwNDcxMSwtNzc2NDgxOTcsMTY1NT
