...
Local representation은 특정한 feature를 표현하는 정보가 대응되는 소규모의 뉴런들에만 존재함을 의미합니다. one-hot encoding은 local representation의 쉬운 예입니다.
## Distributed representation
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5MTc4MjkxNF19
-->