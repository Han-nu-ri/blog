...
우리가 관심 있는 단어 셋이 1000개라고 하고, 각 단어들을 딥러닝을 통해 representation learning하여 더 작은 차원의 벡터로 표현한다고 해보죠. 이 벡터는 one-hot vector에 비해 저차원이 되지만 각 차원의 값들은 0이 아닌 값들이 많고 이를 dense vector라고 합니다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzIxMTAzNTA1LC05MDQyNTgwMzQsMTc0ND
