...
{텐서플로, 딥러닝, 고양이, 강아지} 이 예제로 돌아가보죠. 각 단어를 one-hot encoding의 형태로 표현하기 위해 4차원의 벡터를 사용하였습니다. 그런데 잘 살펴보면, 텐서플로와 딥러닝은
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUyMzU2NDQ2NCwtNzc2NDgxOTcsMTY1NT
