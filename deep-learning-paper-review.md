...
Representation learning은 머신이 원시 데이터로부터 감지나 분류 작업을 위해 필요한 표현들을 자동으로 발견하는 것을 가능하게 해줍니다. 딥러닝 방법들은 간단하지만 비선형인 모듈들을 구성하여, 원시 데이터 입력으로부터 시작하는 표현을 조금 더 높은 추상화 레벨로 바꿔줍니다. 이를 통해 여러 레벨의 표현들을 얻는 Representation learning 방법입니다.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0NjIwNDMyLDEzMzg0MTYxODAsLTEyND
U3MDE2NDFdfQ==
-->