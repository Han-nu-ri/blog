...
2. PCA
이미지 각 pixcel에는 RGB 3개의 값이 있는데요. 세개의 RGB 값의 covariance matrix를 구하고 Eigen  PCA를 통해 RGB 채널 3개의 Covariance matrix
3. Dropout
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4Mjg1MzExMywxMTI2MTczOTY5LDE2OT
