...
이미지, 영상과 같은 시각적 데이터에 사용되는 CNN (Convolutional Neural Network)에 대한 글입니다. 위키피디아, http://taewan.kim/post/cnn/#fnref:3 블로그와 CS231n 강의노트를 참고하였음을 밝힙니다.
## 도입
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjgxNjQ0ODIsLTEzNTA2OTgzOSwtMT
